...
[docker-compose.yml](https://github.com/silencebay/clash-tproxy/blob/mihomo/docker-compose.yml)

[config.yaml](https://github.com/silencebay/clash-tproxy/blob/mihomo/docs/config_tproxy.yaml)
